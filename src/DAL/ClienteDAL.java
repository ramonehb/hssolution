...
public class ClienteDAL extends Conexao{
    ...
    public boolean criarCliente(Cliente cliente) throws SQLException{
        ...
        try {
            ...
            query = conn.prepareStatement("Insert Into Cliente (Nome, Email, DT_Nasc, Telefone, ID_TipoCliente, CpfCnpj, Cep, Endereco, Bairro, Cidade, Estado, Numero, Complemento) Values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ");
            ...
            query.setString(8, cliente.getEndereco().getLogradouro());
